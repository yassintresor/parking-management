 ...
 * tags:
 *   name: Bookings
 *   description: Parking booking endpoints
 * 
 * @swagger
 * tags:
 *   name: Vehicles
 ...
 *         location:
 *           type: string
 *           description: Physical location of the space
 *         type:
 *           type: string
 ...
 *         hourly_rate:
 *           type: number
 *           description: Hourly rate for the space
 *         created_at:
 *           type: string
 *           format: date-time
 ...
 *         vehicle_id:
 *           type: integer
 *           description: Vehicle associated with booking
 *         start_time:
 *           type: string
 *           format: date-time
 ...
 *         success:
 *           type: boolean
 *           description: Success status (false)
 *         message:
 *           type: string
 *           description: Error message
 *         error:
 *           type: string
 *           description: Error details (in development mode)
 */
